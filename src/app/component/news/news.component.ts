...
export class NewsComponent implements OnInit {
  ...
  constructor(public genericservice:GenericService,private formBuilder: FormBuilder) { }
  ...
  ngOnInit(): void {
    ...
    this.cardBln=true;
    this.genericservice.getNews().subscribe((data:any)=>{
